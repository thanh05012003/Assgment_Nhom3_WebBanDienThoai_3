function getDistrict() {
    ...
    var districtjs = document.getElementById("districtjs");
    axios.get("https://online-gateway.ghn.vn/shiip/public-api/master-data/district?province_id=" + provinceID, {
        ...
        .then(function (response) {
            ...
            for (var i = 0; i < response.data.data.length; i++) {
                ...
                districtjs.value = response.data.data[i].DistrictName;
...
function getWard() {
    ...
    var wardjs = document.getElementById("wardjs");
    axios.get("https://online-gateway.ghn.vn/shiip/public-api/master-data/ward?district_id=" + districtID, {
        ...
        .then(function (response) {
            ...
            for (var i = 0; i < response.data.data.length; i++) {
                ...
                wardjs.value = response.data.data[i].WardName;
    ...
    var tongGia = document.getElementById("tongGia").value;
    var phiShip = document.getElementById("phiShip");

    axios.get("https://online-gateway.ghn.vn/shiip/public-api/v2/shipping-order/fee?service_id=53321&insurance_value=" + tongGia + "&coupon&to_ward_code=" + wardCode + "&to_district_id=" + districtID + "&from_district_id=3440&weight=1000&length=20&width=10&height=6", {
        headers: {
            'token': 'a799ced2-febc-11ed-a967-deea53ba3605',
            'shop_id': '4189088'
        }
